...
setlocal indentexpr=GetAikaIndent()
setlocal indentkeys+=0=end,0=until,0=elseif,0=else

" Only define the function once.
if exists("*GetAikaIndent")
  finish
endif
...
let s:skip_expr = "synIDattr(synID(line('.'),col('.'),1),'name') =~# 'aikaComment\\|aikaString'"

function s:IsInCommentOrString(lnum, col)
  return synIDattr(synID(a:lnum, a:col, 1), 'name') =~# 'aikaCommentLong\|aikaString2'
